package psettings.minestom.NMS.v_1_12;
...
public class v_1_12_R1 implements NMS {
    ...
    public void sendSubtitle(Player player, String text, int fadeIn, int stay, int fadeOut) {
        IChatBaseComponent chatSubTitle = IChatBaseComponent.ChatSerializer.a("{\"text\": \"" + text + "\",\"color\":\"" + ChatColor.GOLD.name().toLowerCase() + "\"}");
