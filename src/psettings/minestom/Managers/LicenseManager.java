...
public class LicenseManager {
    ...
    public LicenseManager(String licenseKey, String validationServer, Plugin plugin) {
        this.licenseKey = licenseKey;
        this.plugin = plugin;
        this.validationServer = validationServer;
    }

    public LicenseManager setSecurityKey(String securityKey) {
        this.securityKey = securityKey;
        return this;
    }

    public LicenseManager setConsoleLog(LogType logType) {
        this.logType = logType;
        return this;
    }

    public LicenseManager debug() {
        debug = true;
        return this;
    }

    public boolean register() {
        log(0, "&7Checking your License...");
        ValidationType vt = isValid();
        if (vt == ValidationType.VALID) {
            log(1, "&eLicense approved!");
            return true;
        } else {
            log(1, "&cLicense is NOT valid!");
            log(1, "&vFailed as a result of " + vt.toString());
            log(1, "&cDisabling plugin!");
